...
public class Database {
    ...
    // Tambahkan atribut dari class prodiTbl
    ...
    // menambahkan method createProdi untuk menu tambah prodi
    public void createProdi(Prodi prodi) {
        tables.dataProdi.add(prodi);
        commit();
    }

    // menmbahkan method getProdiById untuk cek id prodi pada tambah dan edit data mahasiswa

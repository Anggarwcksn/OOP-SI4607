...
public class KampusApp {
    ...
    // menambah menu baru yaitu tambah data prodi
    ...
    // jika id prodi yang dimasukkan sudah ada dalam database maka data mahasiswa akan berhasil ditambahkan
    ...
    // jika id prodi yang dimasukkan sudah ada dalam database maka data mahasiswa akan berhasil diubah
    ...
    // membuat menu tambah prodi untuk membuat data prodi yang diperlukan untuk diinputkan (id) di menu tambah dan ubah mahasiswa
